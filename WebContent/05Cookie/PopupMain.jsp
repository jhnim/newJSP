...
<style>
	div#popup{
		...
		color: yellow; border: 0px solid gray; background-color: black;
	}
	
	div#popup>div{
		position: relative; background-color: #ffffff; top: 50px; border: 1px solid gray;
...
%>
	...
	function popClose() {
		...
		/*  
		오늘하루열지않음 체크박스를 체크한 후 닫기를 누르면 JS를 통해 폼값을 전송한다.
		target을 iframe으로 설정하여 페이지 이동이 없는것(비동기)처럼 보이게 한다.
		*/
	...
	<div id="popup">
		...
		<div>
		<form name="popFrm">
			<input type="checkbox" name="isToday" value="1"/> 오늘 하루 열지않음

...
<%
/*
id에 저장된 값이 없다면 로그아웃 상태이므로 로그인 폼을 화면에 출력한다.
*/
if(id.length()==0){
%>
	...
	<!--  
		input태그의 하위속성 tabindex
			: 아이디, 패스워드를입력하기 위해 주로 Tab키를 통해 포커스를 이동하고 싶은데, 
			작성된 순서가 아닌 임의의 순서를 부여하고 싶을때 사용한다.
	-->
	...
	<table border="1">
		<tr>
			...
			<td>
				...
				-->
				<input type="text" name="user_id" tabindex="1" value="<%=(save.length()==0) ?
				"" : save %>" />
				<!--  
